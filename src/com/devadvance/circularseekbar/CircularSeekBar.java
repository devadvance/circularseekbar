...
public class CircularSeekBar extends View {
	 ...
	 * @return Position of the pointer in degrees.
	 */
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_DOWN:
			...
			if (cwDistanceFromStart > mTotalCircleDegrees) {
				Log.i("com.devadvance.circulartest", "Touching the circle gap");
				mUserIsMovingPointer = false;
				return false;
				//break;
			} else if ((touchEventRadius >= innerRadius) && (touchEventRadius <= outerRadius)) { // If the user is touching near the circle
				Log.i("com.devadvance.circulartest", "Touching the circle");
				...
				Log.i("com.devadvance.circulartest", "Not touching the circle");
				mUserIsMovingPointer = false;
				return false;
			}
			break;
